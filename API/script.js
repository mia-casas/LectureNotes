...
- APIs allow applications to communicate with each other; it is an access point to the server, what we call an "endpoint"
- ex. https://localhost/signin -- signin is an endpoint
...
let spaceCars = json.forEach(rockets => {
